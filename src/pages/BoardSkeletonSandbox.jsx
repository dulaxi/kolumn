  ...
  return (
    <div className="min-h-screen bg-[var(--surface-page)] p-6 flex flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center gap-3 shrink-0">
        ...
        <Button size="lg" loading loadingText="Activating">Activate Pro</Button>
      ...
      <div className="flex flex-wrap items-end gap-6 shrink-0">
        {['idle', 'tap', 'hop', 'grow', 'wilt', 'converse', 'blueprint', 'duo', 'connect', 'tick-sweep', 'handshake', 'scurry'].map((name) => (
