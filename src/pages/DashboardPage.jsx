...
import { Plus, ChevronDown, GraduationCap, TrendingUp, PenLine, Code2, Coffee } from 'lucide-react'
  ...
  return (
    <div className="w-full h-full flex flex-col items-center gap-8 pt-[10vh] md:pt-[20vh] px-4 md:px-8">
      <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-7">
            ...
            <div className="flex flex-col m-3.5 gap-3">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="h-8 w-8 rounded-lg flex items-center justify-center hover:bg-[var(--surface-hover)] text-[var(--text-secondary)] transition-colors cursor-pointer"
                >
                ...
                <button
                  type="button"
                  className="h-8 rounded-md px-2.5 inline-flex items-center gap-1.5 text-[14px] text-[var(--text-secondary)] hover:bg-[var(--surface-hover)] transition-colors cursor-pointer"
                  aria-label="Model selector"
                >
                  <span className="whitespace-nowrap select-none">Sonnet 4.6</span>
                  <span className="text-[var(--text-muted)]">Extended</span>
                ...
                <button
                  ...
                  className="h-8 px-1.5 rounded-lg flex items-center justify-center hover:bg-[var(--surface-hover)] text-[var(--text-secondary)] transition-colors cursor-pointer"
                >
        ...
        {/* Category pills */}
        <div className="w-full">
          <ul className="flex flex-wrap justify-center gap-2" role="tablist" aria-label="Prompt categories">
