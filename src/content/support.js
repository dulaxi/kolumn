...
- **Upgrade to Pro.** Pro removes the daily limit and turns on every AI tool in the pill — move, update, complete, and reorganize, not just create. It's $8 a month, with a 7-day free trial. Open \`Settings → Billing\` in the app, or see [Upgrade to Pro](/upgrade/pro).
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary: 'Supabase Postgres, encrypted in transit and at rest, row-level security on every table.',
        updated: '2026-09-02',
        body: null,
      },
      {
