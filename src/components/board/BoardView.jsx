...
export default function BoardView({ boardId, onCardClick, onCreateCard, inlineCardId, onInlineDone, selectedCardId, filters, sortBy }) {
  ...
  return (
    <DndContext {...dndContextProps}>
      ...
      {/* Deliberately no drop animation: the 2026-07-28 motion pass tried
          dnd-kit's default ~250ms settle and it was reverted by choice —
          instant placement feels better here. Don't re-enable casually. */}
