...
export default function QuickAddBar({ boardId }) {
  ...
  return (
    ...
    <div ref={expandedRef} className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-2xl px-4 origin-bottom ${collapsing ? 'animate-[pill-bounce-out_175ms_ease-in_forwards]' : 'animate-[pill-bounce-in_275ms_cubic-bezier(0.16,1,0.3,1)_forwards]'}`}>
